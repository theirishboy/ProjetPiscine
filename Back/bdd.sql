...
INSERT INTO `ebayece`.`objet art` (`ID`, `Nom`, `Description`, `Categorie`, `Type de vente`, `Prix`,`Nimage`) VALUES ('5', '3 WEST COAST IPA de chez Northern Monk', 'Très bonne bière', 'Bon pour le musee', 'Negociation', '30','5');
INSERT INTO `ebayece`.`objet art` (`ID`, `Nom`, `Description`, `Categorie`, `Type de vente`, `Prix`,`Nimage`) VALUES ('6', 'DOOMSDAY DISCO  FRUITY IPA', 'Une bonne bière ', ' Accessoire VIP', 'Achat immediat', '550','6');
