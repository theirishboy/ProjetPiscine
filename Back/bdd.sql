...
CREATE TABLE `ebayece`.`Vendeur` ( `Humain` INT(10) NOT NULL , INDEX (`Humain`),`Imagesback` VARCHAR(100) NOT NULL,`Imagesprofile` VARCHAR(100) NOT NULL) ENGINE = MyISAM ; 
CREATE TABLE `ebayece`.`Admin` ( `Humain` INT(10) NOT NULL , INDEX (`Humain`)) ENGINE = MyISAM; 
CREATE TABLE `ebayece`.`objet art` ( `ID` INT(10) NOT NULL AUTO_INCREMENT, `Nom` VARCHAR(50) NOT NULL , `Description` VARCHAR(250) NOT NULL , `Categorie` VARCHAR(50) NOT NULL , `Type de vente` VARCHAR(50) NOT NULL , `Prix` INT(10) NOT NULL ,`Nimage` INT(10) NOT NULL,`IDclient` INT(10) NOT NULL ,PRIMARY KEY (`ID`)) ENGINE = MyISAM; 
...
INSERT INTO `ebayece`.`vendeur`(`Humain`,`Imagesback`,`Imagesprofile`) VALUES ('3','','');
...
INSERT INTO `ebayece`.`objet art` (`ID`, `Nom`, `Description`, `Categorie`, `Type de vente`, `Prix`,`Nimage`,`IDclient`) VALUES ('1', 'Bijoux de la reine Marie Tudor', 'Bijoux de la reine Marie Alisa bloody Mary', 'Bon pour le musee', 'Enchere', '450','4','3');
INSERT INTO `ebayece`.`objet art` (`ID`, `Nom`, `Description`, `Categorie`, `Type de vente`, `Prix`,`Nimage`,`IDclient`) VALUES ('2', '6 pieces or', 'Lot de 6 pieces de 20 francs en or coq de Chaplain de 1907 et une 1912', 'Ferraille ou Tresor', 'Enchere', '1500 ','1','3');
INSERT INTO `ebayece`.`objet art` (`ID`, `Nom`, `Description`, `Categorie`, `Type de vente`, `Prix`,`Nimage`,`IDclient`) VALUES ('3', 'Medaille Raspail', 'Medaille circulaire en bronze figurant Raspail "L ami du peuple" de profil. Diametre : 14 cm', 'Ferraille ou Tresor', 'Enchere', '15','2','3');
INSERT INTO `ebayece`.`objet art` (`ID`, `Nom`, `Description`, `Categorie`, `Type de vente`, `Prix`,`Nimage`,`IDclient`) VALUES ('4', '3 pieces Napoleon III', 'Lot de 3 piece de 20 francs en or Napoleon III dattant de 1853 1860 et 1862', 'Ferraille ou Tresor', 'Enchere', '550','3','3');
INSERT INTO `ebayece`.`objet art` (`ID`, `Nom`, `Description`, `Categorie`, `Type de vente`, `Prix`,`Nimage`,`IDclient`) VALUES ('5', '3 WEST COAST IPA de chez Northern Monk', 'Très bonne bière', 'Bon pour le musee', 'Negociation', '30','5','3');
INSERT INTO `ebayece`.`objet art` (`ID`, `Nom`, `Description`, `Categorie`, `Type de vente`, `Prix`,`Nimage`,`IDclient`) VALUES ('6', 'DOOMSDAY DISCO  FRUITY IPA', 'Une bonne bière ', ' Accessoire VIP', 'Achat immediat', '550','6','3');
INSERT INTO `ebayece`.`objet art` (`ID`, `Nom`, `Description`, `Categorie`, `Type de vente`, `Prix`,`Nimage`,`IDclient`) VALUES ('7', 'Rolex en or 18 carat', 'Rolex avec bracelet en or 18 carats pour femme accompagnée de son boitier rond.', 'Accessoire VIP', 'Achat immediat', '2800','7','3');
INSERT INTO `ebayece`.`objet art` (`ID`, `Nom`, `Description`, `Categorie`, `Type de vente`, `Prix`,`Nimage`,`IDclient`) VALUES ('8', 'Rolex, montre bracelet Oyster en acier et or', 'Rolex, montre avec bracelet Oyster en acier et or datant de 1986 toujours en parfait état. Accompagné de sa boite', 'Accessoire VIP', 'Enchere', '1050','8','3');
INSERT INTO `ebayece`.`objet art` (`ID`, `Nom`, `Description`, `Categorie`, `Type de vente`, `Prix`,`Nimage`,`IDclient`) VALUES ('9', 'Duo de stylos Montblanc', 'Duo de stylo plume en or 18 carat et feutre fluo. Accompagné de l’étui d’origine.', 'Accessoire VIP', 'Negociation', '670','9','3');
INSERT INTO `ebayece`.`objet art` (`ID`, `Nom`, `Description`, `Categorie`, `Type de vente`, `Prix`,`Nimage`,`IDclient`) VALUES ('10', 'Sac de voyage Louis Vuitton', 'Sac de voyage en toile monogrammée 48x60 cm Louis Vuitton', 'Accessoire VIP', 'Negociation', '385','10','3');
INSERT INTO `ebayece`.`objet art` (`ID`, `Nom`, `Description`, `Categorie`, `Type de vente`, `Prix`,`Nimage`,`IDclient`) VALUES ('11', 'Valide rigide Louis Vuitton', 'Valide rigide en toile enduite monogrammée et cuire avec plateau et clé Louis Vuitton', 'Accessoire VIP', 'Enchere', '1900','11','3');
INSERT INTO `ebayece`.`objet art` (`ID`, `Nom`, `Description`, `Categorie`, `Type de vente`, `Prix`,`Nimage`,`IDclient`) VALUES ('12', 'Echarpe en cachemire Hermès', 'Echarpe à franges en cachemire noir dans sa boite d’origine Hermès', 'Accessoire VIP', 'Achat immediat', '150','12','3');
INSERT INTO `ebayece`.`objet art` (`ID`, `Nom`, `Description`, `Categorie`, `Type de vente`, `Prix`,`Nimage`,`IDclient`) VALUES ('13', 'Etole en cachemire Yves-Saint Laurent', 'Etole neuve en cachemire polychrome sur fond jaune 135x135 cm Yves-Saint Laurent', 'Accessoire VIP', 'Achat immediat', '180','13','3');
INSERT INTO `ebayece`.`objet art` (`ID`, `Nom`, `Description`, `Categorie`, `Type de vente`, `Prix`,`Nimage`,`IDclient`) VALUES ('14', 'Bague en or blanc et saphir jaune', 'Bague en or blanc et saphir jaune ovale 8.10 cts agrémenté de 41 diamants blancs', 'Accessoire VIP', 'Enchere', '1490','14','3');
INSERT INTO `ebayece`.`objet art` (`ID`, `Nom`, `Description`, `Categorie`, `Type de vente`, `Prix`,`Nimage`,`IDclient`) VALUES ('15', 'Bague en or blanc et rubis', 'Bague en or blanc et rubis ovale 2.11 cts entouré de 20 diamants 0.20 ct', 'Accessoire VIP', 'Negociation', '1650','15','3');
INSERT INTO `ebayece`.`objet art` (`ID`, `Nom`, `Description`, `Categorie`, `Type de vente`, `Prix`,`Nimage`,`IDclient`) VALUES ('16', 'Bracelet en or', 'Bracelet articulé à grosses mailles en or', 'Accessoire VIP', 'Enchere', '1000','16','3');
