        ...
        <div class="container">    
            <div class="row">       
                <div class="col-lg-5 col-md-8 col-sm-12">       
                    <h4 class="text-uppercase font-weight-bold text-center"><b>Information additionnelle</b></h4>       
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">       
                    <h4 class="text-uppercase font-weight-bold text-center"><b>Contact</b></h4>       
                ...
                <div class="col-lg-3 col-md-5 col-sm-12" id="image">       
                    ...
                    <a aria-label="Facebook" title="Facebook" href="https://facebook.com">
                      <img src="Images/facebook.png" alt="Facebook" height="72">
                    </a>
                    <a aria-label="Instagram" title="Instagram" href="https://instagram.com">
                      <img src="Images/instagram.png" alt="Instagram" height="60">
                    </a>
