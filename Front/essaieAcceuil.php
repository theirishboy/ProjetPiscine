        ...
        $chemin1= mysqli_fetch_assoc($cheminimg1);
          ...
          echo '<div class="col-xs-6 col-md-4">';
            echo '<div class="thumbnail">';
              ...
              echo '<p>Catégorie : '.$data1['Categorie'].'</p>';
              echo '<p>Type de vente : '.$data1['Type de vente'].'</p>';
              echo '<p>Prix : '.$data1['Prix'].' €</p><br>';
        ...
        $chemin2= mysqli_fetch_assoc($cheminimg2);
          ...
          echo '<div class="col-xs-6 col-md-4">';
            echo '<div class="thumbnail">';
              ...
              echo '<p>Catégorie : '.$data2['Categorie'].'</p>';
              echo '<p>Type de vente : '.$data2['Type de vente'].'</p>';
              echo '<p>Prix : '.$data2['Prix'].' €</p><br>';
        ...
        $chemin3= mysqli_fetch_assoc($cheminimg3);
          ...
          echo '<div class="col-xs-6 col-md-4">';
            echo '<div class="thumbnail">';
              ...
              echo '<p>Catégorie : '.$data3['Categorie'].'</p>';
              echo '<p>Type de vente : '.$data3['Type de vente'].'</p>';
              echo '<p>Prix : '.$data3['Prix'].' €</p><br>';
